...
CREATE TABLE IF NOT EXISTS gold.dm_piloto (
    srk_piloto              SERIAL PRIMARY KEY, 
    chave_piloto_origem     INTEGER UNIQUE NOT NULL, 
...
CREATE TABLE IF NOT EXISTS gold.dm_equipe (
    ...
    chave_equipe_origem     INTEGER UNIQUE NOT NULL, 
...
CREATE TABLE IF NOT EXISTS gold.dm_corrida (
    ...
    chave_corrida_origem    INTEGER UNIQUE NOT NULL, 
...
CREATE TABLE IF NOT EXISTS gold.dm_status (
    ...
    chave_status_origem     INTEGER UNIQUE NOT NULL, 
...
CREATE TABLE IF NOT EXISTS gold.ft_voltas_tempo_parada (
    srk_tempo_volta         BIGSERIAL PRIMARY KEY, 
