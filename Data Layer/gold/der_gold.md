...
### 2.1. Componentes do Diagrama

- **FT_VOLTAS_TEMPO_PARADA** é a tabela de fato central. Cada linha representa a menor granularidade disponível (volta do piloto na corrida) e carrega métricas de tempo, pit stop, pontos e vitórias.
- **Dimensões** (`DM_PILOTO`, `DM_EQUIPE`, `DM_CORRIDA`, `DM_STATUS`) oferecem contexto descritivo. Todas utilizam *surrogate keys* (`SRK`) e mantêm a *business key* (`chave_*_origem`) para rastreabilidade.
...
| :--: | :----: | :-------- | :---- | :----- |
| 31/10/2025 | `1.0` | Documentação do DER. | [Kaleb Macedo](https://github.com/kalebmacedo) e [Othavio Bolzan](https://github.com/bolzanMGB) | — |
